    ...
    <article id="contact">
      ...
      <section>
        <div className="google-form">
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSe_J5WoG902RX6L88VgOiBw1XmMf58keOUKJ_cj2BodFEz2WA/viewform?embedded=true">読み込んでいます…</iframe>
        </div>
        <div className="content">
          <p>本サイト、もしくは個人に対して御用の方はTwitter<a href="https://twitter.com/wellxxx_" target="_blank">@wellxxx_</a>のDM（推奨）又はフォームからご連絡ください。2日程度にてご返信いたします。
